...
def convert_f_to_all(temperature_f):
    ...
    print(f'{convert_f_to_c(temperature_f).round(2)} in C')
    print(f'{convert_f_to_k(temperature_f).round(2)} in K')
